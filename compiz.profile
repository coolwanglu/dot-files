...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;gnomecompat;crashhandler;dbus;regex;png;imgjpeg;mousepoll;text;workarounds;ezoom;screenshot;svg;switcher;animation;wall;wobbly;animationaddon;scale;
...
[animation]
s0_open_effects = animation:Dream;9;9;
...
s0_close_effects = animation:Curved Fold;9;9;
...
s0_minimize_effects = animation:Curved Fold;
...
s0_zoom_factor = 1.100000
s0_minimum_zoom = 0.093800
s0_sync_mouse = true
s0_scale_mouse = true
...
s0_mouse_pan = false
s0_restrain_margin = 9
s0_pan_factor = 0.001000
